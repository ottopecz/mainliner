module.exports = class Container {
  ...
  getTamperedVertexData_(current) {
    ...
    if (this.modifiers_.optional.isOptional(current)) {
      ...
      vertexData = this.graph_.getVertexData(choppedOptional) || {"type": "optional"};
    } else if (this.modifiers_.factory.isFactory(current)) {

      const choppedCurrent = this.modifiers_.factory.chop(current);

      vertexData = this.graph_.getVertexData(choppedCurrent);
      ...
      vertexData = this.graph_.getVertexData(current);
    }
