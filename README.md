...
> **mainliner** is written in node6 and that's waht is exported by default. However a node4 version is built and it is included in the package. You can access it like `const mainliner = require("mainliner/node4-lib/index");` or if you are using es6 modules `import mainliner from "mainliner/node4-lib/index";`
